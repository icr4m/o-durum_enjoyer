...
SRCS = $(addprefix srcs/, ast_diagram.c read_line.c exit.c utils.c)
...
INCS = $(addprefix includes/, lexing.h built_in.h exec.h ft_signal.h garbage_collector.h minishell.h struct.h )
